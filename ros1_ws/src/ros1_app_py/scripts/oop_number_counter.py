...
class NumberCounter:
    ...
    def __init__(self):
        self.counter_ = 0
        self.number_subscriber_ = rospy.Subscriber("number", Int64, self.callback_number)
        self.reset_service_ = rospy.Service("reset_counter", ResetCounter, self.callback_reset_counter)
